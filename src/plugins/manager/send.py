...
group = send.command(
    ...
    state=MatcherData(
        ...
        params=[
            CommandParam(
                name="群号", description="群号", param_type=ParamType.REQUIRED
            ),
            CommandParam(
                name="消息", description="消息", param_type=ParamType.VARIADIC
            ),
        ],
    ).model_dump(),
)
user = send.command(
    ...
    state=MatcherData(
        ...
        params=[
            CommandParam(
                name="用户ID", description="用户ID", param_type=ParamType.REQUIRED
            ),
            CommandParam(
                name="消息", description="消息", param_type=ParamType.VARIADIC
            ),
