...
def upgrade(name: str = "") -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["quality"],
            ["fishing_quality_meta.name"],
            name=op.f("fk_fish_meta_quality_fishing_quality_meta"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["fish_name"],
            ["fish_meta.name"],
            name=op.f("fk_fish_record_fish_name_fish_meta"),
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["fishing_user_meta.user_id"],
            name=op.f("fk_fish_record_user_id_fishing_user_meta"),
        ),
