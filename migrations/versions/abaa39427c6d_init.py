...
迁移 ID: abaa39427c6d
父迁移:
创建时间: 2025-07-10 09:25:57.636323
...
def upgrade(name: str = "") -> None:
    ...
    op.create_table(
        ...
        sa.Column("default_balance", sa.Numeric(precision=16, scale=4), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("balance", sa.Numeric(precision=16, scale=4), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("currency_id", sa.String(length=32), nullable=False),
        sa.Column("amount", sa.Numeric(precision=16, scale=4), nullable=False),
        sa.Column("action", sa.String(length=20), nullable=False),
        sa.Column("source", sa.String(length=64), nullable=False),
        sa.Column("balance_before", sa.Numeric(precision=16, scale=4), nullable=False),
        sa.Column("balance_after", sa.Numeric(precision=16, scale=4), nullable=False),
